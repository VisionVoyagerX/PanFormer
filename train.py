...
def main():
    ...
    model = CrossSwinTransformer(ms_channels=8, n_feats=64, n_heads=8, head_dim=8, win_size=4,
    ...
    for step in train_progress_bar:
        if step % save_interval == 0 and step != 0:
            ...
            save_checkpoint(checkpoint, 'panformer_WV3', current_daytime)
        ...
        if (step + 1) in evaluation_interval and step != 0:
            ...
            if val_metrics[-1]['psnr'] > best_eval_psnr:
                ...
                checkpoint = {'step': step,
                              ...
                              'val_metrics': val_metrics,
                              'test_metrics': test_metrics}
                save_checkpoint(checkpoint, 'panformer_WV3',
